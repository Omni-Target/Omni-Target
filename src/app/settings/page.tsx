            ...
            {metaConnected ? (
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div className="flex items-center gap-3">
                  <div className="w-2.5 h-2.5 rounded-full bg-green-500 shadow-[0_0_8px_rgba(34,197,94,0.5)]"></div>
                  <div>
                    <p className="text-sm font-medium text-white">Account ID: {integration.meta_ad_account_id}</p>
                    <span className="inline-flex items-center px-2 py-0.5 rounded-md bg-green-500/10 text-green-400 text-xs font-medium border border-green-500/20 mt-1">
                      Connected
                    </span>
                  </div>
                </div>
                <button className="text-xs text-white/40 hover:text-white/70 transition-colors underline underline-offset-2 shrink-0 self-start sm:self-center">
                  Disconnect
                </button>
              </div>
            ) : (
